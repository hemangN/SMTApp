...
public class stage_two_statistic extends Activity implements OnClickListener{

	LinearLayout lyt_appback;
	TextView txt_stage_two_stat;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.stage_two_statistics_screen);
		
		context = stage_two_statistic.this;
			
		txt_stage_two_stat = (TextView)findViewById(R.id.txt_stage_two_stat);
		...
		percentage = Application.prefrences.Get_Nicotine_After_Stage2();
		day_taken    = Application.prefrences.Get_Days_Taken_Stage2();
		txt_prog_percent.setText(String.format("%.2f", percentage)+"%");
		txt_num_days_to_comp.setText(""+day_taken);
		
		message = "I have Reduced "+Application.prefrences.Get_Nicotine_After_Stage2()+"% Nicotine in my body using smoke therapy app";
	}

	public void setFontTypeFace()
	{		
		txt_stage_two_stat.setTypeface(Application.tf);
	...
	public void onClick(View v) 
	{
		...
		case R.id.btn_share_stat:
			...
			break;
		case R.id.btn_back:
			stage_two_statistic.this.finish();
	...
	{
		LayoutInflater layoutInflater = (LayoutInflater) stage_two_statistic.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
